...
export const EnvConfigSchema = z.object({
  ...
  BAILIAN_BASE_URL: z.string().default(''),
  ZHIPU_API_KEY: z.string().default(''),
  ZHIPU_BASE_URL: z.string().default(''),
  MOONSHOT_API_KEY: z.string().default(''),
  MOONSHOT_BASE_URL: z.string().default(''),
  ERNIE_API_KEY: z.string().default(''),
  ERNIE_BASE_URL: z.string().default(''),
  SPARK_API_KEY: z.string().default(''),
  SPARK_BASE_URL: z.string().default(''),
  HUNYUAN_API_KEY: z.string().default(''),
  HUNYUAN_BASE_URL: z.string().default(''),
  MINIMAX_API_KEY: z.string().default(''),
  MINIMAX_BASE_URL: z.string().default(''),
  DEEPSEEK_API_KEY: z.string().default(''),
  DEEPSEEK_BASE_URL: z.string().default(''),
  YI_API_KEY: z.string().default(''),
  YI_BASE_URL: z.string().default(''),
  BAICHUAN_API_KEY: z.string().default(''),
  BAICHUAN_BASE_URL: z.string().default(''),
