      ...
      {open && (
        <div className="absolute right-0 mt-2 w-56 rounded-lg border border-slate-200 bg-white py-1 shadow-lg dark:border-slate-700 dark:bg-slate-800 z-50 animate-fade-in">
          <div className="border-b border-slate-200 px-4 py-2 dark:border-slate-700">
            <div className="text-xs text-slate-500 dark:text-slate-400">{t('settings.apiKey')}</div>
            <div className="font-mono text-sm text-slate-700 dark:text-slate-200">{userId}…</div>
          </div>
          <button
